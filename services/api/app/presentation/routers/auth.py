...
from app.application.dependencies import OAuthServiceDependency, OAuthFormData, OAuthToken
...
async def login(auth_service: OAuthServiceDependency, form_data: OAuthFormData) -> TokenResponse:
...
async def logout(auth_service: OAuthServiceDependency, token: OAuthToken) -> JSONResponse:
...
async def refresh(auth_service: OAuthServiceDependency, token: OAuthToken) -> TokenResponse:
